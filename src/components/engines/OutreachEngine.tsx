        ...
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <header className="mb-8">
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                    <div className="space-y-2 max-w-xl">
                        <span className="text-tertiary font-bold text-[9px] uppercase tracking-widest antialiased opacity-60 font-label">Distribution Protocol</span>
                        <h1 className="text-xl md:text-2xl font-bold font-headline tracking-tighter text-white uppercase antialiased">Outreach Strategy</h1>
                    ...
                    <div className="flex gap-3">
                        <button className="px-4 py-2 bg-surface-container-high/60 backdrop-blur-3xl text-white font-bold text-[10px] uppercase tracking-wider rounded-lg border border-white/5 hover:bg-tertiary transition-all shadow-md antialiased">
                            Export Sync
                        </button>
                    </div>
                </div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                ...
                <div className="md:col-span-3 group p-6 rounded-xl bg-surface-container-low border border-white/5 hover:bg-surface-container transition-all shadow-md relative overflow-hidden">
                    ...
                    <h3 className="text-lg font-bold font-headline mb-3 text-white uppercase tracking-tight antialiased">Primary Protocol</h3>
                ...
                {data.templates.map((template, i) => (
                    <div key={i} className="group p-5 rounded-xl bg-surface-container-high/40 backdrop-blur-3xl border border-white/5 hover:bg-surface-container transition-all shadow-md relative overflow-hidden">
                        ...
                        <h4 className="text-white font-bold font-headline uppercase text-[11px] tracking-tight antialiased mb-3">Template 0{i + 1}</h4>
                        ...
                        <button className="mt-4 text-tertiary text-[9px] font-bold uppercase tracking-widest flex items-center gap-2 transition-all antialiased">
            ...
            <section className="bg-surface-container rounded-2xl overflow-hidden shadow-lg border border-white/5 mb-16">
                <div className="p-6 border-b border-white/5 flex justify-between items-center bg-gradient-to-r from-white/5 to-transparent">
                    <div>
                        <h3 className="text-lg font-bold font-headline text-white uppercase tracking-tight antialiased">Live Distribution Nodes</h3>
                        <p className="text-[9px] text-on-surface-variant font-bold uppercase tracking-widest mt-1 antialiased opacity-40">Campaign Performance Matrix</p>
                    </div>
                </div>
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-surface-container-low/30">
                            <tr className="text-on-surface-variant/40 text-[9px] font-bold uppercase tracking-widest antialiased">
                            ...
                            {data.campaigns.map((campaign, i) => (
                                <tr key={i} className="group hover:bg-white/5 transition-all cursor-default">
                                    <td className="px-6 py-4">
                                        <div className="font-bold text-white uppercase tracking-tight antialiased text-[12px]">{campaign.name}</div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <span className={cn(
