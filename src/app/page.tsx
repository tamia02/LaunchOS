            ...
            <nav className="fixed top-0 w-full z-50 bg-slate-900/60 backdrop-blur-xl flex justify-between items-center h-16 px-8 max-w-full shadow-[0px_4px_12px_rgba(0,0,0,0.2)]">
                <div className="flex items-center gap-8">
                    ...
                    <div className="hidden md:flex gap-6 items-center">
                        ...
                        <Link className="text-slate-400 font-medium hover:text-slate-200 transition-colors duration-200 font-body text-sm" href="/projects">Projects</Link>
                        <Link className="text-slate-400 font-medium hover:text-slate-200 transition-colors duration-200 font-body text-sm" href="/insights">Insights</Link>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    <button className="bg-surface-container-high text-slate-200 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-surface-bright transition-all duration-300 scale-95 active:scale-90">
                        Upgrade to Pro
                    </button>
                    <div className="w-8 h-8 rounded-full bg-surface-container overflow-hidden border border-outline-variant/20">
                        <img alt="Founder Profile" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA7eF7035V9Ps5oLjD3xDo1FvYEW4YzEijIuyCwn-ASxUM_9MEfiXkiyfOglCBLldt0JhyM4TNKy32_8mA1e0rJRZXUfTB6GDPN-LSlQFo4Smz3cm7pn2uB27O559S3wGflBelQZXyq-D7hFB5H9LyZZFuKJWTwTaZfRo5j17B9HgrJpu0O6gyZVtEMSaeHCfYrLoKpbrPHLuRSK76HcgWCJZNrVgWZjjDlFC_w_yCtkviN8FVLW_28R0-xGMQrKFjTCpunZ_7z8N8f" />
                    </div>
                </div>
            </nav>
            ...
            <main className="relative min-h-screen flex flex-col hero-gradient pt-16">
                ...
                <section className="flex-1 flex flex-col items-center justify-center px-6 text-center py-20 lg:py-32">
                    ...
                    <div className="mt-24 flex flex-wrap justify-center gap-8 md:gap-16 opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
                        <span className="font-headline font-bold text-xl uppercase italic">Techstars</span>
                        <span className="font-headline font-bold text-xl uppercase italic">YCombinator</span>
                        <span className="font-headline font-bold text-xl uppercase italic">Sequoia</span>
                        <span className="font-headline font-bold text-xl uppercase italic">Andreessen</span>
                    </div>
                </section>
                ...
                <section className="px-8 md:px-12 py-32 bg-surface-container-low/30">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-4">
                        ...
                        <div className="md:col-span-8 h-[500px] bg-surface-container rounded-xl overflow-hidden relative group border border-outline-variant/10">
                            <img alt="OS Interface Preview" className="w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-[2000ms] ease-out" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB4yV-Rr56-9JYvmldC8C8yiTlp05-1uhU-b-EicYqH76M16pwqi81iQJK0Mkju6gYYpxykktv7l4ao5Jrb1-S6wB6LHlYvMzj4Xcdi60Xpriu_Ml_hc0I4nAiGuxO1U4saGrlb5U0ejZGDIc4rUxgsE8qC5o_avb7XnV4Gq4-uxf1y9Y_ohdcNbnU67lURtlK6tyI_0bBcZKwze8O0gkZOTbICLay_f3LqQd2Fbh_MoM4FYSlzrtgyMVVYRK3kjEcq4s-Cr5v3Dwh-" />
                        ...
                        <div className="md:col-span-4 bg-surface-container rounded-xl p-8 border border-outline-variant/10">
                            <Megaphone className="text-on-surface-variant w-8 h-8 mb-6" />
                        ...
                        <div className="md:col-span-8 bg-surface-container-highest rounded-xl p-8 border border-outline-variant/10 flex items-center gap-12">
                            <div className="hidden lg:block w-32 h-32 flex-shrink-0 bg-surface rounded-full border border-outline-variant/20 overflow-hidden">
                                <Globe className="w-full h-full p-6 text-on-surface-variant opacity-50" />
                            </div>
                            <div>
                ...
                <section className="py-32 px-6 text-center">
                    <div className="max-w-4xl mx-auto glass-panel bg-surface-container/40 p-16 rounded-3xl border border-outline-variant/10 relative overflow-hidden">
                        ...
                        <button className="button-metallic text-on-primary px-10 py-5 rounded-lg font-headline font-bold tracking-tight hover:scale-105 active:scale-95 transition-all duration-300 shadow-xl">
