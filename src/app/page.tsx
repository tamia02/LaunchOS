...
export default function LandingPage() {
    ...
    return (
        <div className="bg-[#0A0A0A] text-[#FAFAFA] selection:bg-[#C8F135]/30 selection:text-[#C8F135] min-h-screen antialiased font-sans">
            ...
            <nav className="fixed top-0 w-full z-50 bg-[#0A0A0A]/80 backdrop-blur-xl flex justify-between items-center h-16 px-8 max-w-full border-b border-white/10">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link href="/login" className="bg-[#C8F135] text-black px-4 py-2 rounded-lg text-sm font-bold hover:bg-[#C8F135]/90 transition-all">
                        Start Free
                    </Link>
                </div>
            </nav>
            ...
            <main className="relative min-h-screen flex flex-col pt-16">
                ...
                {/* SECTION 1: HERO */}
                <section className="flex flex-col items-center justify-center px-6 text-center py-24 lg:py-32">
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight max-w-4xl leading-[1.1] mb-8">
                        From raw idea to <br className="hidden md:block" /> <span className="text-[#C8F135]">validation</span> in seconds.
                    </h1>
                    <p className="text-xl text-[#888888] max-w-2xl leading-relaxed mb-10">
                        10 AI engines analyze your startup idea in 2 minutes. Niche. Validation. MVP. Pricing. Outreach. Investors. Everything a founder needs. One platform.
                    </p>
                    
                    <Link href="/login" className="bg-[#C8F135] text-black px-8 py-4 rounded-xl font-bold text-lg tracking-wide hover:bg-[#C8F135]/90 transition-all flex items-center justify-center gap-2 mb-4">
                        Analyze Your Idea Free →
                    </Link>
                    <p className="text-sm text-[#888888] mb-12">No credit card required · 3 free analyses</p>

                    <div className="inline-flex items-center gap-4 px-6 py-3 rounded-full bg-[#111111] border border-white/10 text-sm text-[#888888]">
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="bg-[#111111] p-8 rounded-2xl border border-white/10">
                                <div className="w-12 h-12 bg-[#C8F135]/10 rounded-xl flex items-center justify-center text-[#C8F135] mb-6">
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
                            {engines.map((engine, idx) => (
                                <div key={idx} className="bg-[#111111] p-6 rounded-2xl border border-white/10 flex flex-col hover:border-[#C8F135]/30 transition-colors">
                                    <div className="flex justify-between items-start mb-4">
                                        <span className="text-[#C8F135] font-mono font-bold text-sm">{engine.num}</span>
                ...
                <section className="py-24 px-6 border-t border-white/5 bg-[#0A0A0A]">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <div className="lg:w-[400px] bg-[#C8F135] p-10 rounded-3xl text-black flex flex-col justify-center">
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-4 gap-6">
                            ...
                            <div className="bg-[#111111] p-6 rounded-3xl border border-white/10 flex flex-col">
                                ...
                                <p className="text-xs font-mono text-[#C8F135] mb-6 bg-[#C8F135]/10 inline-block px-2 py-1 rounded w-fit">500 credits/mo</p>
                                <ul className="space-y-3 mb-8 flex-1 text-sm">
                            ...
                            {/* MEDIUM */}
                            <div className="bg-[#111111] p-6 rounded-3xl border border-[#C8F135]/50 flex flex-col relative shadow-[0_0_40px_rgba(200,241,53,0.1)] transform md:-translate-y-4">
                                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#C8F135] text-black text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest whitespace-nowrap">Most Popular</div>
                                <h3 className="font-bold text-xl mb-2 text-[#C8F135]">MEDIUM</h3>
                                ...
                                <p className="text-xs font-mono text-[#C8F135] mb-6 bg-[#C8F135]/10 inline-block px-2 py-1 rounded w-fit">2,000 credits/mo</p>
                                <ul className="space-y-3 mb-8 flex-1 text-sm">
                                ...
                                <Link href="/login" className="w-full text-center py-3 rounded-xl bg-[#C8F135] text-black font-bold hover:bg-[#C8F135]/90 transition-colors">Get Medium</Link>
                            </div>
                            ...
                            <div className="bg-[#111111] p-6 rounded-3xl border border-white/10 flex flex-col">
                                ...
                                <p className="text-xs font-mono text-[#C8F135] mb-6 bg-[#C8F135]/10 inline-block px-2 py-1 rounded w-fit">5,000 credits/mo</p>
                                <ul className="space-y-3 mb-8 flex-1 text-sm">
                ...
                <section className="py-32 px-6 border-t border-white/5 bg-[#0A0A0A] text-center">
                    <div className="max-w-4xl mx-auto bg-[#111111] p-16 rounded-[2rem] border border-white/10 relative overflow-hidden">
                        <div className="absolute top-0 right-0 -mr-32 -mt-32 w-96 h-96 bg-[#C8F135]/10 rounded-full blur-3xl pointer-events-none"></div>
                        <div className="absolute bottom-0 left-0 -ml-32 -mb-32 w-96 h-96 bg-[#C8F135]/5 rounded-full blur-3xl pointer-events-none"></div>
                        ...
                        <div className="relative z-10">
                            ...
                            <Link href="/login" className="bg-[#C8F135] text-black px-12 py-5 rounded-xl font-bold text-lg tracking-wide hover:bg-[#C8F135]/90 transition-all inline-block mb-6">
                                Analyze My Idea →
                            </Link>
